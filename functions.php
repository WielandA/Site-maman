<?php
	...
	// control adding of scripts	
	function michele_register_js() {
		// deregistering jquery - bad practice, but using bundled jquery does not work (on MAMP at least)
		wp_deregister_script('jquery');
		wp_register_script('jquery', "http" . ($_SERVER['SERVER_PORT'] == 443 ? "s" : "") . "://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js", false, true);
		
		wp_register_script('all', get_template_directory_uri().'/js/all.js', array('jquery'), '', true);
		wp_register_script('fancybox', get_template_directory_uri().'/js/fancybox-2.0.6.js', array('jquery'), '', true);
		wp_register_script('submenu', get_template_directory_uri().'/js/submenu.js', array('jquery'), '', true);
		wp_register_script('scrollto', get_template_directory_uri().'/js/scrollto-1.4.2-min.js', array('jquery'), '', true);
		wp_register_script('localscroll', get_template_directory_uri().'/js/localscroll-1.2.7-min.js', array('jquery', 'scrollto'), '', true);
	}

	function michele_enqueue_js() {
	...
	add_action('init', 'michele_register_js');
	add_action('wp_enqueue_scripts', 'michele_enqueue_js');
